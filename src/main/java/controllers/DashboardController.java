...
public class DashboardController {
    ...
    public void AjouterPrd(ActionEvent actionEvent) {
        try {
    ...
    public void DisplayEvents(ActionEvent actionEvent) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/AjouterGaleriesController.fxml"));
            messageLabel.getScene().setRoot(root);
        } catch (IOException e) {
            e.printStackTrace(); // Print the full stack trace
        }
    ...
    public void getFacture(ActionEvent actionEvent) {

        try {
            Parent root = FXMLLoader.load(getClass().getResource("/FactureViewBack.fxml"));
            messageLabel.getScene().setRoot(root);
        } catch (IOException e) {
            e.printStackTrace(); // Print the full stack trace
        }
    ...
    public void GetCommandes(ActionEvent actionEvent) {
        try {
    ...
    /*
    public void AjouterPrd(MouseEvent mouseEvent) {
