...
public class AfficherUtilisateurController {
    ...
    @FXML
    private TableColumn<Utilisateur, String> numcol;
    ...
    @FXML
    private TableColumn<Utilisateur, String> descol;
    ...
    void getData(MouseEvent event) {
        ...
        if (utilisateur != null) {
            ...
            Des.setText(utilisateur.getDescription());
        }
    }
    ...
    public void updateUser(ActionEvent actionEvent) {
        ...
        if (selectedUtilisateur != null) {
            ...
            selectedUtilisateur.setUsername(Username.getText());
            ...
            selectedUtilisateur.setDescription(Des.getText());
    ...
    public void DisplayDl(ActionEvent actionEvent) {
        try {
    ...
    public void AddPerso(ActionEvent actionEvent) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/AdminAjouterUtilisateur.fxml"));
            Fname.getScene().setRoot(root);
        } catch (IOException e) {
            e.printStackTrace(); // Print the full stack trace
        }
