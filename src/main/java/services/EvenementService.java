...
public class EvenementService implements IService<Evenement> {
    ...
    public List<Evenement> rechercher(String nom, LocalDate date) throws SQLException {
        List<Evenement> evenements = new ArrayList<>();
        StringBuilder query = new StringBuilder("SELECT * FROM evenements WHERE 1=1");
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(query.toString())) {
            ...
            while (resultSet.next()) {
                ...
                evenement.setHeure(resultSet.getTime("heure").toLocalTime());
                evenement.setDescription(resultSet.getString("description"));
                evenement.setGalerieID(resultSet.getInt("GalerieID")); // Utilisez setGalerieID pour définir la valeur de la propriété GalerieID
